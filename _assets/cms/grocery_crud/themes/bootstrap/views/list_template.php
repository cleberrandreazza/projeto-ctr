...
<div class="action-header">
    ...
    <?php }?>
    <a class="search-button t5 btn btn-default">
...
<?php }?>
    <br/>
    <div class="gc-container" style="margin:0; padding:0;">
        ...
        ?></div>
 		...
 		<div class="row" style="margin:0; padding:0;">
        	<div class="col-md-12 table-section" style="margin:0; padding:0;">
        			    ...
        			    <table class="table table-bordered grocery-crud-table table-hover">
        					<thead>
        						...
        						<tr class="filter-row gc-search-row">
                                    ...
                                    <?php /*foreach($columns as $column){?>
                                        <td>
                                            <input type="text" class="form-control searchable-input floatL" placeholder="<?php echo $column->display_as; ?>" name="<?php echo $column->field_name; ?>" />
                                        </td>
                                    <?php }*/?>
        						</tr>
