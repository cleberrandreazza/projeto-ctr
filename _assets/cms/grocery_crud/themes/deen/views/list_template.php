<?php
	...
	$this->set_js($this->default_theme_path.'/deen/js/cookies.js');
	$this->set_js($this->default_theme_path.'/deen/js/flexigrid.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/deen/js/jquery.printElement.min.js');
...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="active"><?php echo $subject?></li>
    </ol>
</div>
...
<div class="action-header">
    ...
    <a class="btn btn-primary" href="<?php echo $add_url?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject?>">
        <i class="glyphicon glyphicon-plus icon-white"></i> <?php echo $this->l('list_add'); ?> <?php echo $subject?>
    </a>
    <?php }?>
    <?php if(!$unset_export) { ?>
    <a class="btn btn-default" href="<?php echo $export_url; ?>" title="Exportar" target="_blank">
        <i class="glyphicon glyphicon-export icon-white"></i> <?php echo $this->l('list_export');?>
    </a>
    <?php } ?>
    <?php if(!$unset_print) { ?>
    <a class="btn btn-default" href="<?php echo $print_url?>" title="Imprimir" target="_blank">
        <i class="glyphicon glyphicon-print icon-white"></i> <?php echo $this->l('list_print');?>
    </a>
    <?php }?>
</div>
<?php }?>
<div data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="action-header" id='quickSearchBox'>
		<div class="sDiv2">
			<?php echo $this->l('list_search');?>: <input type="text" class="form-control" name="search_text" size="30" id='search_text'>
            ...
            <input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear search_clear' class="btn btn-default">
		</div>
	</div>
    <nav>
      <ul class="pagination">
